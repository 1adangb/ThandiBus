...
public class RutasPAdapter extends ArrayAdapter<QueryDocumentSnapshot>
{
    private Context mContext;
    private List<QueryDocumentSnapshot> listaRutas = new ArrayList<>();


    public RutasPAdapter(@NonNull Context context, int resource, @NonNull List<QueryDocumentSnapshot> objects)
    {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent)
    {
        ...
        txRuta.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(mContext,UserMapsActivity.class);
